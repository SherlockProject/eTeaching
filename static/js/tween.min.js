...
TWEEN.Tween=function(a){var c={},b={},d={},e=1E3,g=0,h=!1,l=!1,t=0,p=null,z=TWEEN.Easing.Linear.None,A=TWEEN.Interpolation.Linear,q=[],u=null,v=!1,w=null,x=null,m=null,y;for(y in a)c[y]=parseFloat(a[y],10);this.to=function(a,c){void 0!==c&&(e=c);b=a;return this};this.reset=function(){for(i in d)Object.prototype.hasOwnProperty.call(d,i)&&(a[i]=d[i])};this.start=function(e){TWEEN.add(this);l=!0;v=!1;p=void 0!==e?e:"undefined"!==typeof window&&void 0!==window.performance&&
void 0!==window.performance.now?window.performance.now():Date.now();p+=t;for(var f in b){if(b[f]instanceof Array){if(0===b[f].length)continue;b[f]=[a[f]].concat(b[f])}c[f]=a[f];!1===c[f]instanceof Array&&(c[f]*=1);d[f]=c[f]||0}return this};this.stop=function(){if(!l)return this;TWEEN.remove(this);l=!1;null!==m&&m.call(a);this.stopChainedTweens();return this};this.stopChainedTweens=function(){for(var a=0,b=q.length;a<b;a++)q[a].stop()};this.delay=function(a){t=a;return this};this.repeat=function(a){g=
a;return this};this.yoyo=function(a){h=a;return this};this.easing=function(a){z=a;return this};this.interpolation=function(a){A=a;return this};this.chain=function(){q=arguments;return this};this.onStart=function(a){u=a;return this};this.reverse = function () { w.call( c ); };this.onUpdate=function(a){w=a;return this};this.onComplete=function(a){x=a;return this};this.onStop=function(a){m=a;return this};this.update=function(r){var f;if(r<p)return!0;!1===v&&(null!==u&&u.call(a),v=!0);var k=(r-p)/e,k=1<k?1:k,l=z(k);for(f in b){var m=c[f]||0,n=
b[f];n instanceof Array?a[f]=A(n,l):("string"===typeof n&&(n=m+parseFloat(n,10)),"number"===typeof n&&(a[f]=m+(n-m)*l))}null!==w&&w.call(a,l);if(1==k)if(0<g){isFinite(g)&&g--;for(f in d)"string"===typeof b[f]&&(d[f]+=parseFloat(b[f],10)),h&&(k=d[f],d[f]=b[f],b[f]=k),c[f]=d[f];p=r+t}else{null!==x&&x.call(a);f=0;for(k=q.length;f<k;f++)q[f].start(r);return!1}return!0}};
